...
- [specs/0022-code-task-streaming.md](specs/0022-code-task-streaming.md)：V2.4.0 代码任务生成流式化 SPEC 草案（待项目负责人审批；SSE 端点绕过 Worker，复用 SPEC 0018/0019/0020/0021 流式架构；保留 Worker 异步端点兼容）。
